...
def get_model(show_summary=True):
    """
    This function defines a keras model and returns the model 
    as an object.
    """
    # one_hot dimension for categorical features
    input_features = []
    for keys, dim in CAT_FEATURES.items():
        input_features.append(
            tf.keras.Input(shape=(dim + 1), 
                           name=transformed_name(keys)))
    ...
    deep = tf.keras.layers.Dense(32, activation="relu")(concatenate)
